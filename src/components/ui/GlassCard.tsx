  ...
  ({
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className="relative h-full rounded-[50px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 shadow-2xl transition-all duration-500 ease-in-out [transform-style:preserve-3d] group-hover:[box-shadow:rgba(0,0,0,0.3)_30px_50px_25px_-40px,rgba(0,0,0,0.1)_0px_25px_30px_0px] group-hover:[transform:rotate3d(1,1,0,30deg)]">
          ...
          <div className="absolute [transform:translate3d(0,0,26px)]">
            <div className="px-7 pt-[60px] pb-0">
              {step && (
                <div className="w-16 h-16 bg-gradient-to-br from-electric-blue to-cyber-purple rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 text-white">
                  {step}
                </div>
              )}
              ...
              <span className="mt-3 block text-[13px] text-gray-300 text-center leading-relaxed">
                {description}
              </span>
            </div>
          </div>
          {showSocialIcons && (
            <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between [transform-style:preserve-3d] [transform:translate3d(0,0,26px)]">
              ...
              <div className="flex w-2/5 cursor-pointer items-center justify-end transition-all duration-200 ease-in-out hover:[transform:translate3d(0,0,10px)]">
                <button className="border-none bg-none text-xs font-bold text-electric-blue hover:text-cyber-purple transition-colors">
                  View more
                </button>
                <ChevronDown className="h-4 w-4 stroke-electric-blue transition-colors hover:stroke-cyber-purple" strokeWidth={3} />
              </div>
            </div>
          )}
