        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-6">
            <div className="flex rounded-lg bg-white/5 p-1">
              <a
                href="/signup"
                className="flex-1 px-4 py-2 text-center rounded-md font-medium bg-electric-blue text-white transition-all"
              >
                Sign Up
              </a>
              <a
                href="/login"
                className="flex-1 px-4 py-2 text-center rounded-md font-medium text-gray-300 hover:text-white hover:bg-white/10 transition-all"
              >
                Login
              </a>
            </div>
