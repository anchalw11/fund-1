...
export default function Dashboard() {
  ...
  const navItems = [
    ...
    { id: 'affiliates', icon: UserPlus, label: 'Affiliates', comingSoon: true },
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.comingSoon && (
                      <span className="absolute -top-1 -right-1 text-xs px-1.5 py-0.5 bg-orange-500 text-white rounded-full animate-pulse">
                        Soon
                      </span>
                    )}
                  </button>
...
function AffiliatesSection({ user }: { user: any }) {
  return (
    <div className="text-center py-16">
      ...
      <p className="text-xl text-white/70 mb-6">Coming Soon!</p>
      <p className="text-white/60 mb-8 max-w-md mx-auto">
        We're building an amazing affiliate program that will allow you to earn commissions by referring new traders to Fund8r.
      </p>
      <div className="flex items-center justify-center gap-4 text-lg text-electric-blue mb-6">
        <div className="flex items-center gap-2">
      ...
      <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-electric-blue/20 to-neon-purple/20 border border-electric-blue/30 rounded-lg backdrop-blur-sm">
        ...
        <span className="font-semibold text-white">Launch expected soon</span>
      </div>
    </div>
  );
}
