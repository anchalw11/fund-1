...
// Extend window interface for Twitter tracking
declare global {
  interface Window {
    twq?: any;
  }
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {finalPrice === 0 && appliedCoupon && (
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-500 py-4 text-lg font-semibold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
          >
            {verifying ? (
              <>
