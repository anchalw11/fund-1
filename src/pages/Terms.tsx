    ...
    <div className="min-h-screen bg-deep-space">
      ...
      <div className="max-w-4xl mx-auto px-4 py-24">
        ...
        <div className="space-y-8 text-gray-300">
          ...
          <section id="mini-challenge-terms">
            <h2 className="text-3xl font-bold mb-4">8. Mini Challenge Terms</h2>
            <p className="leading-relaxed">
              The Free Mini Challenge is an unpaid evaluation designed to assess trading skills. Any profits generated during the Mini Challenge are virtual and will not be paid out in cash. Instead, traders who successfully complete the challenge by meeting the profit target without violating any rules will receive a credit equivalent to the price of a funded account challenge. This credit can be used to purchase a funded account challenge, where real profits can be earned and withdrawn according to our standard profit split terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              For questions regarding these terms: legal.fund8r@gmail.com
            </p>
          </section>
        </div>
      </div>
