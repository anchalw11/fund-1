      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 text-center">
              ...
              <p className="text-gray-400">
                Select from $5K to $2M account sizes starting at just $12
              </p>
            </div>
        ...
        <section id="challenges" className="py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass-card p-8 hover:border-orange-500/50 transition-all cursor-pointer group" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-orange-400">Starting from $14</p>
            </div>
            ...
            <div className="glass-card p-8 border-2 border-blue-500/50 hover:border-blue-500 transition-all cursor-pointer group relative" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-blue-400">Starting from $19</p>
            </div>
            ...
            <div className="glass-card p-8 hover:border-green-500/50 transition-all cursor-pointer group" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-green-400">Phase 1 from $12</p>
            </div>
            ...
            <div className="glass-card p-8 hover:border-red-500/50 transition-all cursor-pointer group" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-red-400">Starting from $16</p>
            </div>
            ...
            <div className="glass-card p-8 hover:border-purple-500/50 transition-all cursor-pointer group" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-purple-400">Starting from $18</p>
            </div>
            ...
            <div className="glass-card p-8 hover:border-yellow-500/50 transition-all cursor-pointer group" onClick={() => window.location.href = '/challenge-types'}>
              ...
              <p className="text-sm text-yellow-400">Starting from $1699</p>
            </div>
          </div>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Mini Challenge */}
            <div className="glass-card p-6 hover:border-yellow-500/50 transition-all group">
              <div className="text-5xl mb-4">🏆</div>
              <h3 className="text-2xl font-bold mb-3 text-yellow-400">Free Mini Challenge</h3>
              <p className="text-gray-400 mb-4 text-sm">
                Experience our platform risk-free! $3K virtual capital, 7 days to prove your skills. 100% FREE.
              </p>
              <a
                href="/challenge-types"
                className="inline-block px-6 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-semibold rounded-lg hover:scale-105 transition text-sm"
              >
            ...
            <div className="glass-card p-6 hover:border-purple-500/50 transition-all group">
              <div className="text-5xl mb-4">🏅</div>
              <h3 className="text-2xl font-bold mb-3 text-purple-400">Achievement Badges</h3>
              <p className="text-gray-400 mb-4 text-sm">
                Earn badges for speed, consistency, and payout milestones. Show off your achievements!
              </p>
              <a
                href="/badges"
            ...
            {/* Subscriptions */}
            <div className="glass-card p-6 hover:border-blue-500/50 transition-all group">
              <div className="text-5xl mb-4">♾️</div>
              <h3 className="text-2xl font-bold mb-3 text-blue-400">Unlimited Subscriptions</h3>
              <p className="text-gray-400 mb-4 text-sm">
                Unlimited retries, monthly or quarterly billing. Perfect for committed traders.
              </p>
              <a
                href="/subscriptions"
                className="inline-block px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-lg hover:scale-105 transition text-sm"
              >
                View Plans
              </a>
            </div>
            ...
            {/* Second Chance */}
            <div className="glass-card p-6 hover:border-green-500/50 transition-all group">
              <div className="text-5xl mb-4">🎁</div>
              <h3 className="text-2xl font-bold mb-3 text-green-400">Second Chance Offers</h3>
              <p className="text-gray-400 mb-4 text-sm">
                Didn't pass? Get special retry offers, extensions, and discounts. Everyone deserves another shot.
              </p>
              <a
                href="/second-chance"
                className="inline-block px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-lg hover:scale-105 transition text-sm"
              >
                Learn More
              </a>
            </div>
