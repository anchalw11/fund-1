...
class AffiliateService {
  ...
  async getAffiliateStats(identifier) {
    // IMMEDIATE SAFETY CHECK - return safe defaults if any errors
    try {
      // Validate input
      if (!identifier || typeof identifier !== 'string') {
        console.log('Invalid identifier provided, returning safe defaults');
        return {
          affiliate_code: '',
          total_referrals: 0,
          active_referrals: 0,
      ...
      if (!affiliate) {
        console.log('No affiliate found for identifier:', identifier, 'returning safe defaults');
        return {
          affiliate_code: '',
          total_referrals: 0,
          active_referrals: 0,
      ...
      // Validate affiliate object has required properties
      if (!affiliate.id || typeof affiliate.id !== 'string') {
        console.log('Invalid affiliate data, returning safe defaults');
        return {
          affiliate_code: '',
          total_referrals: 0,
          active_referrals: 0,
